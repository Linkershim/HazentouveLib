...
public class HLKeyMapping extends KeyMapping {
    private boolean canBeConsumed;
    private boolean wasDown;

    public HLKeyMapping(String description, IKeyConflictContext keyConflictContext, InputConstants.Type inputType, int keyCode, String category) {
