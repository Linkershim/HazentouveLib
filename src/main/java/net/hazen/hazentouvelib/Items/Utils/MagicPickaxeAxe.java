...
public class MagicPickaxeAxe extends PickaxeAxe {
    private List<SpellData> spellData = null;
    private final SpellDataRegistryHolder[] spellDataRegistryHolders;

    public MagicPickaxeAxe(Tier tier, Properties properties, SpellDataRegistryHolder... spellDataRegistryHolders) {
